...
use crate::cad::{Cad, Cost, CostFn, Meta, MetaAnalysis, Rewrite};
...
pub fn depth_under_mapis(e: &RecExpr<Cad>) -> usize {
...
pub type MyRunner = egg::Runner<Cad, MetaAnalysis, MyIterData>;
