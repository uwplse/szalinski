...
//Hole for a 2x3 array of keystone jacks
	if (hole_type == "keystone6")
	{
          for(i=[-24.75,0,24.75])
          {
            translate([i,0,0])
            {
		translate([0,-15,5]) cube([16.5,15,10], center = true);
		translate([0,15,5]) cube([16.5,15,10], center = true);
            }
          }
	}
...
//Hole for a side-by-side Keystone Jack pair
  if (hole_type == "keystone2") {
    translate([0,-12,5]) cube([16.5,15,10], center = true);
    translate([0,12,5]) cube([16.5,15,10], center = true);
  }
  ...
  if (hole_type == "keystone6_solid")
  {
    for(i=[-24.75,0,24.75])
    {
      translate([i,0,0])
      {
        translate([0,-15,0]) keystone_frame();
        translate([0,15,0]) keystone_frame();
      }
    }
  }
...
//Keystone3_solid hole - three keystones down the middle
  if (hole_type == "keystone3_solid")
  {
    for(i=[-24.75,0,24.75])
    {
      translate([i,0,0])
      {
        translate([0,0,0]) keystone_frame();
      }
    }
  }
...
//Hole for a side-by-side Keystone Jack frame pair
  if (hole_type == "keystone2_solid") {
    translate([0,-12,0]) keystone_frame();
    translate([0,12,0]) keystone_frame();
  }
...
//Keystone Solid
  rotate([0,0,90])
  {
    difference()
    {
      translate([02,02,.1]) cube([19,26.5,9.8]);
      translate([4,4,0])
      {
        difference()
        {
