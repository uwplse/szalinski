...
//
//	v1.3a
//	ADDED: Keystone jack pair
//
//	v1.3b
//	ADDED: whole-plate 2x3 array of Keystone jacks
//
//  v1.4 by rssalerno
//  ADDED: 1x3 array of Keystone jacks
//  FIXED: bugs in plates 4 and 5
//
//  v1.41.1 by rssalerno
//  UPDATED: cleaned up a bit
//  UPDATED: revised keystone frame for easier insertion, same frame now used for all configurations
//  ADDED: keystone clearance parameter to adjust fit
//  UPDATED: adjusted keystone column spacing, now distributes evenly across 2+ gangs
//  UPDATED: changed rocker opening to rounded rectangle
...
// rocker and Insteon mini remote-related parameters
rocker_openingX = 33.8;
rocker_openingY = 68.0;
rocker_opening_cornerR = 0.75;
...
module plate4(){
	if (4th_plate == "toggle" || 5th_plate_bottom_hole == "toggle"){
	...
	else if (4th_plate == "long_toggle" || 5th_plate_bottom_hole == "long_toggle"){
		translate([0,l_offset[plate_size] + switch_offset * 3,0]) toggle_screws();
		translate([0,l_offset[plate_size] + switch_offset * 3,0]) hole("long_toggle");
		}
	else if (4th_plate == "rocker" || 5th_plate_bottom_hole == "rocker"){
	...
	else if (4th_plate == "outlet" || 5th_plate_bottom_hole == "outlet") {
...
else if (1st_plate == "keystone2" && 1st_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5,-3.9]) hole("keystone2_solid");
	}
else if (1st_plate == "keystone2" && 1st_plate_bottom_hole != "outlet" && 1st_plate_bottom_hole != "toggle" && 1st_plate_bottom_hole != "rocker") {
	translate([height_sizes[plate_size]/2,l_offset[plate_size] - 11.5,-3.9]) hole("keystone2_solid");
	}
else if (1st_plate == "keystone3" && 1st_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5,-3.9]) hole("keystone3_solid");
	}
else if (1st_plate == "keystone6" && 1st_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5,-3.9]) hole("keystone6_solid");
	}
if (1st_plate_bottom_hole == "keystone1" && 1st_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5,-3.9]) hole("keystone_solid");
	}
if (1st_plate_bottom_hole == "keystone2" && 1st_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5,-3.9]) hole("keystone2_solid");
	}
...
else if (1st_plate_bottom_hole == "keystone2" && 1st_plate != "outlet" && 1st_plate != "toggle" && 1st_plate != "rocker") {
	translate([height_sizes[plate_size]/2 + 28.5,l_offset[plate_size] - 11.5,-3.9]) hole("keystone2_solid");
	}
}
...
else if (2nd_plate == "keystone2" && 2nd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone2_solid");
	}
else if (2nd_plate == "keystone2" && 2nd_plate_bottom_hole != "outlet" && 2nd_plate_bottom_hole != "toggle" && 2nd_plate_bottom_hole != "rocker") {
	translate([height_sizes[plate_size]/2,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone2_solid");
	}
else if (2nd_plate == "keystone3" && 2nd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone3_solid");
	}
else if (2nd_plate == "keystone6" && 2nd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone6_solid");
	}
if (2nd_plate_bottom_hole == "keystone1" && 2nd_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone_solid");
	}
if (2nd_plate_bottom_hole == "keystone2" && 2nd_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone2_solid");
	}
...
else if (2nd_plate_bottom_hole == "keystone2" && 2nd_plate != "outlet" && 2nd_plate != "toggle" && 2nd_plate != "rocker") {
	translate([height_sizes[plate_size]/2 + 28.5,l_offset[plate_size] - 11.5 + switch_offset,-3.9]) hole("keystone2_solid");
	}
}
...
else if (3rd_plate == "keystone2" && 3rd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone2_solid");
	}
else if (3rd_plate == "keystone2" && 3rd_plate_bottom_hole != "outlet" && 3rd_plate_bottom_hole != "toggle" && 3rd_plate_bottom_hole != "rocker") {
	translate([height_sizes[plate_size]/2,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone2_solid");
	}
else if (3rd_plate == "keystone3" && 3rd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone3_solid");
	}
else if (3rd_plate == "keystone6" && 3rd_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone6_solid");
	}
if (3rd_plate_bottom_hole == "keystone1" && 3rd_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone_solid");
	}
if (3rd_plate_bottom_hole == "keystone2" && 3rd_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone2_solid");
	}
...
else if (3rd_plate_bottom_hole == "keystone2" && 3rd_plate != "outlet" && 3rd_plate != "toggle" && 3rd_plate != "rocker") {
	translate([height_sizes[plate_size]/2 + 28.5,l_offset[plate_size] - 11.5 + switch_offset * 2,-3.9]) hole("keystone2_solid");
	}
}
...
else if (4th_plate == "keystone2" && 4th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone2_solid");
	}
else if (4th_plate == "keystone2" && 4th_plate_bottom_hole != "outlet" && 4th_plate_bottom_hole != "toggle" && 5th_plate_bottom_hole != "rocker") {
	translate([height_sizes[plate_size]/2,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone2_solid");
	}
else if (4th_plate == "keystone3" && 4th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone3_solid");
	}
else if (4th_plate == "keystone6" && 4th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone6_solid");
	}
if (4th_plate_bottom_hole == "keystone1" && 4th_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone_solid");
	}
if (4th_plate_bottom_hole == "keystone2" && 4th_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone2_solid");
	}
...
else if (4th_plate_bottom_hole == "keystone2" && 4th_plate != "outlet" && 4th_plate != "toggle" && 4th_plate != "rocker") {
	translate([height_sizes[plate_size]/2 + 28.5,l_offset[plate_size] - 11.5 + switch_offset * 3,-3.9]) hole("keystone2_solid");
	}
}
...
else if (5th_plate == "keystone2" && 5th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone2_solid");
	}
else if (5th_plate == "keystone2" && 5th_plate_bottom_hole != "outlet" && 5th_plate_bottom_hole != "toggle" && 5th_plate_bottom_hole != "rocker") {
	translate([height_sizes[plate_size]/2,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone2_solid");
	}
else if (5th_plate == "keystone3" && 5th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone3_solid");
	}
else if (5th_plate == "keystone6" && 5th_plate_bottom_hole == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone6_solid");
	}
if (5th_plate_bottom_hole == "keystone1" && 5th_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone_solid");
	}
if (5th_plate_bottom_hole == "keystone2" && 5th_plate == "none") {
	translate([height_sizes[plate_size]/2 + 14.3,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone2_solid");
	}
...
else if (5th_plate_bottom_hole == "keystone2" && 5th_plate != "outlet" && 5th_plate != "toggle" && 5th_plate != "rocker") {
	translate([height_sizes[plate_size]/2 + 28.5,l_offset[plate_size] - 11.5 + switch_offset * 4,-3.9]) hole("keystone2_solid");
	}
}
...
// Box screw holes
module box_screws(){
	 translate([height_sizes[plate_size]/2 + 41.67125,0,-1]) cylinder(r=2, h=10);
...
module rocker_screws(){
	 translate([height_sizes[plate_size]/2 + 48.41875,0,-1]) cylinder(r=2, h=10);
...
module toggle_screws(){
	 translate([height_sizes[plate_size]/2 + 30.1625,0,-1]) cylinder(r=2, h=10);
	 translate([height_sizes[plate_size]/2 + 30.1625,0,3.5]) cylinder(r1=2, r2=3.3, h=3);
	 translate([height_sizes[plate_size]/2 - 30.1625,0,-1]) cylinder(r=2, h=10);
	 translate([height_sizes[plate_size]/2 - 30.1625,0,3.5]) cylinder(r1=2, r2=3.3, h=3);
}

module roundedRectangle(width, height, cornerRadius) {
    hull() {
        ...
        translate([width-cornerRadius, height-cornerRadius, 0]) circle(r=cornerRadius);
        translate([cornerRadius, height-cornerRadius, 0]) circle(r=cornerRadius);
    }
}
...
// Rocker switch plate
	if (hole_type == "rocker") {
		...
		translate([height_sizes[plate_size]/2,0,0]) linear_extrude(15) translate([-rocker_openingY/2,-rocker_openingX/2,]) roundedRectangle(rocker_openingY, rocker_openingX, rocker_opening_cornerR);
...
//Keystone6 hole
//Hole for a 2x3 array of keystone jacks
    if (hole_type == "keystone6") {
        for(i=[-24.75,0,24.75]) {
            translate([i,0,0]) {
                keystone_hole(-keystone_column_offset);
                keystone_hole(keystone_column_offset);
            }
        }
    }
...
//Keystone3 hole
//Hole for a 1x3 array of keystone jacks
	if (hole_type == "keystone3") {
        for(i=[-24.75,0,24.75]) {
            translate([i,0,0]) keystone_hole(0);
        }
	}
      
    
//Keystone2 hole
//Hole for a side-by-side Keystone Jack pair
    if (hole_type == "keystone2") {
        keystone_hole(-keystone_column_offset);
        keystone_hole(keystone_column_offset);
    }

  //Keystone6_solid hole
    if (hole_type == "keystone6_solid") {
        for(i=[-24.75,0,24.75]) {
            translate([i,0,0]) {
                translate([0,-keystone_column_offset,0]) keystone_solid();
                translate([0,keystone_column_offset,0]) keystone_solid();
            }
            }
    }
  
//Keystone3_solid hole - three keystones down the middle
  if (hole_type == "keystone3_solid")
  {
    for(i=[-24.75,0,24.75])
    {
      translate([i,0,0])
      {
        translate([0,0,0]) keystone_solid();
      }
    }
  }
        
//Keystone2_solid hole
//Hole for a side-by-side Keystone Jack frame pair
   ...
   rotate([0,0,90])
  {
    difference()
    {
...

      {
        difference()
        {
          cube([15+keystone_clearance,22.5+keystone_clearance,10]);
