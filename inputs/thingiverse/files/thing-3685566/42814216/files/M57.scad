...
// Muzzle Width
muzzlew=13.5;     //[5:0.5:40.5]
    //width of the muzzle slot

// Muzzle Roundness
muzzleslotroundness=6.5;  //[0:.5:20]
...
module vertrise()
{
    difference()
    {
        ...
        translate([0,(width-thick*2)/2,muzzletoph])roundedcube([thick*20,21.5,(muzzletoph-muzzlebottomh)*2-17],true,muzzleslotroundness);
    }
