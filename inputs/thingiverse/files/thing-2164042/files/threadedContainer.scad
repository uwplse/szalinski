// Show parts
part = 2; // [2:All opened, 1:Base, 2:Lid, 3:Closed]
...
outer_diameter = inner_diameter + thread_step + 1.5;
...
module lid() {
    ...
    difference() {
        union() {
            ...
            hex_screw(thread_outer_diameter-1, thread_step, step_shape_degrees, thread_length-1, resolution, countersink, 0, 0, 0, 0);
        }
     translate([0, 0, -0.1]) cylinder(d=thread_outer_diameter-thread_step-1.5, h=thread_length);
    }
}
