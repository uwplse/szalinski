// Show parts
part = 0; // [2:All opened, 1:Base, 2:Lid, 3:Closed]
...
outer_diameter = inner_diameter + 2*thread_step;
...
module lid() {
    ...
    difference() {
     ...
     translate([0, 0, -0.1]) cylinder(d=thread_outer_diameter-2*thread_step, h=thread_length);
    }
}
