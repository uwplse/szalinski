...
Pulley1Diameter = 100; // [12.5:200]
Pulley2Diameter = 90; // [0:200]
Pulley3Diameter = 0; // [0:200]
Pulley4Diameter = 0; // [0:200]
Pulley5Diameter = 0; // [0:200]
Pulley6Diameter = 0; // [0:200]
IncludeSetScrew = 0; // [0:No Set Screw,1:Pulley 1,2: Pulley 2]

module DrawErrorFlag(stepList, stepCount) {
  FlagSize = max(max(stepList),20);
