...
difference(){
    ...
    translate([0,0,pushheight-1.0])linear_extrude(height = 2, convexity = 10)text(NAME, font=FONTNAME, size=FONTSIZE, valign="center", halign="center");
}
