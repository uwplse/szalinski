...
letter_7_space = 10; // [-20:1:20]

letter_8_height = 3; // [-20:1:20]
letter_8_space = 10; // [-20:1:20]

letter_9_height = 4; // [-20:1:20]
letter_9_space = 10; // [-20:1:20]

letter_10_height = 6; // [-20:1:20]
letter_10_space = 10; // [-20:1:20]
...
spacing = [0,letter_1_space,letter_2_space,letter_3_space,letter_4_space,letter_5_space,letter_6_space,letter_7_space,letter_8_space,letter_9_space,letter_10_space];

// of each letter (e.g. 5 letters = 5 comma seperated numbers [4,3,3.5,3,4])
height = [letter_1_height,letter_2_height,letter_3_height,letter_4_height,letter_5_height,letter_6_height,letter_7_height,letter_8_height,letter_9_height,letter_10_height];
