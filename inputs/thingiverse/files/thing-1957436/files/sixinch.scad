...
Part = "b"; // [a:All, b:FrontPlate, c:Cabinet, d:Lid, e:BackPlate, f:Handles]
Units = 4;
Depth = 115;
...
module frontplate(u,square_hole,round_hole,round_peg,screw_side_front,screw_top,screw_bottom_front){
    ...
    */
    ...
    translate([0,0,gauge]){
        translate([20+width*0.3,gauge_box+0.2,0]){  cube([width*0.4,1,1]);  }
        translate([20+width*0.3,unit*u-1-gauge_box-0.2,0]){  cube([width*0.4,1,1]);  }           
    }
