...
tolerance = 0.5;
// Distance of the knob to the desk
desk_distance = 2;
...
rotate([0,90,0]) difference()
{
	...
	union()
	{
		...
		union()
		{
			...
			{
				// main body block
				translate([-holder_diameter/2-desk_distance, -holder_diameter/2, thumbwheel_height + tolerance]) cube([holder_diameter/2+desk_distance, holder_diameter, holder_height]);
				// cylinder cut
