...
Labels=["290","280","270","260","250","240","230","220"];
NumberOfBlocks = len(Labels);
MaterialLabel= "PET-G-181030";
ReverseLabelOrder=0; //[0:False, 1:True]
Reverse=ReverseLabelOrder == 1;
Makeholes = 0; //[0:False, 1:True]
//TwinTowers = 0; //[0:False, 1:True]
...
FontFace=1;// [0:Arial Bold,1:Liberation Sans,2:Open Sans,3:Montserrat,4:Dosis,5:Orbitron]
...
else
{
    ...
    linear_extrude(.3)
        union(){
        text("You must modify your print gcode", 4);
            translate([0,-6,0])
        text("to change the temperatures! OK?", 4);}
}
