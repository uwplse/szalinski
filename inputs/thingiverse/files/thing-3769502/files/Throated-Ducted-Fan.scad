...
//Propellor Diameter (mm)
prop_dia_upper = 123; //[30:0.5:500]
//Spacing between Duct and Prop (mm)
...
module slice_throat(){
    translate([0,-throat_length,0]){
        square([lip_dia, throat_length]);
    }
}
...
module slice_lower_duct(){
    ...
    translate([lip_dia/2,(-shroud_lower_length/2)-throat_length,0]){
        square([lip_dia,shroud_lower_length], center = true);
    }
    
    //Cutting Triangle
        triangle_points = [[0,-throat_length], [0,-throat_length-shroud_lower_length], [ lower_length, -throat_length-shroud_lower_length]]; //TEST SO FAR
