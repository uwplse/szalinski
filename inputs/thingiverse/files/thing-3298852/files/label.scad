...
// render just text=1, just baseplate=2 or both=3
mode = 3;
    ...
    difference () {
        union () {
            ...
            for (TZT_i=[-2:4:2]) {
                ...
                translate ([(TZT_Width+TZT_Height)/TZT_i,0,0]) {
                    cylinder (3,3,3,true);
                }
            }
        }
        translate ([0,0,1.5]) {
            union () {
                ...
                for (TZT_i=[-2:4:2]) {
                    ...
                    translate ([(TZT_Width+TZT_Height+1)/TZT_i,0,0]) {
