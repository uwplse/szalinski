...
// Remixed by Vivalize December 2017
...
module pulley( belt_type , pulley_OD , tooth_depth , tooth_width )
{
    ...
    difference() {
        translate([0,0,0.005]) cylinder (h = width-0.01, r=(pulley_OD/2)+thickness, center = false, $fn = teeth*10);
        difference()
        {
            union()
            {
                difference()
                {
                    ...
                    cylinder(r=pulley_OD/2,h=width, $fn=teeth*4);
...
module T2_5()
{
    linear_extrude(width=width+2) polygon([[-0.839258,-0.5],[-0.839258,0],[-0.770246,0.021652],[-0.726369,0.079022],[-0.529167,0.620889],[-0.485025,0.67826],[-0.416278,0.699911],[0.416278,0.699911],[0.484849,0.67826],[0.528814,0.620889],[0.726369,0.079022],[0.770114,0.021652],[0.839258,0],[0.839258,-0.5]]);
}
