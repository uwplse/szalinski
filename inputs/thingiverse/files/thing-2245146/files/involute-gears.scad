...
module bevel_gear_pair (
	...
	gear2_teeth = 7,
	axis_angle = 90,
	outside_circular_pitch=10)
{
	outside_pitch_radius1 = gear1_teeth * outside_circular_pitch / (2*pi);
	outside_pitch_radius2 = gear2_teeth * outside_circular_pitch / (2*pi);
	...
	finish = -1)
{
	...
	outside_pitch_diameter  =  number_of_teeth * outside_circular_pitch / pi;
...
= number_of_teeth * circular_pitch / pi /2;
function gear_addendum(circular_pitch,number_of_teeth)
= 1/(number_of_teeth / (2*pitch_radius(circular_pitch,number_of_teeth)));
	...
	flat=false)
{
	...
	pitch_radius = pitch_radius(circular_pitch,number_of_teeth);
...
translate([0,pitch_radius(10,20)+pitch_radius(10,10),0])
rotate([0,0,0])
gear(
	circular_pitch = 10,
	gear_thickness = 10,
