...
// 1=round or 0=square 
hole_shape=1; // 1=square or 0=round 
...
if (hole_shape==0) translate([size*cos(slope)-wall_thickness,0,0]) rotate([0,90,0]) cylinder(  15, d1=hole_dia,  d2=hole_dia,$fn=60);
if (hole_shape==1)  translate([size*cos(slope)+wall_thickness*3,0,0]) rotate([0,90,0])cube(size = [square_hole,square_hole,size/2], center = true);
