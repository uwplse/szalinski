...
rotate(180) quarterCylinder(100);
}
...
rotate(-270) quarterCylinder(300);


}

intersection() {
translate([0,bWid-bWid*0.2/(1-cos(degr)),0])
scale([(bLen/2 - phone_width/2)/4/(sin(degr)), bWid*0.2/(1-cos(degr)), 1])
rotate(270) quarterCylinder(300);
    
translate([(bLen/2 - phone_width/2)/4,bWid*0.5,0])
cube(1000);
...
rotate(180)
difference() {
cylinder(h=clip_thickness, r=1, $fn=ne);
translate([50, 0, -1]) 
    scale([-1,1,1])
cube(1000);
