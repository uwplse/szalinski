...
// Copyright (c) 2017 Luc Belliveau
// LGPL

// Uses https://github.com/brodykenrick/text_on_OpenSCAD
...
if (cup_text != false) {
    text_width = width_of_text_string_num_length(
      len(cup_text)-1,
      size=(base_height-shim_height)/2,
    ...
    text_on_cylinder(
        t=cup_text,
        r1=expanded_diameter/2,
        r2=expanded_diameter/2,
        h=(base_height-shim_height)/2,
        extrusion_height=3,
        cylinder_center=true,
        center=true,
        size=(base_height-shim_height)/2,
        eastwest=-45-text_width/2,
        updown=0-(base_height-shim_height)/4
    );
}
