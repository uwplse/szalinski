...
h=117;			//	высота цилиндра
n=16;			//	количество сот на окружности
dw=15;		//	расстояние между гранями соты
h1=4.8;			//	высота выступа соты
...
difference() {
union() {
translate([0,0,0])cylinder(h-dh/5, dc/2, dc/2, $fn=128);
...
//%translate([0,0,-h/2+1]) cylinder(h+1, dc/2-1, dc/2-1, $fn=128);
