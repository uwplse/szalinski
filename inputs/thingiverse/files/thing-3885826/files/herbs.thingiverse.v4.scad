...
bottom_plate_depth = 2.5;		// [0.4:0.2:50]

bottom_plate_height = 0;		// [0.4:0.2:50]

back_plate_depth = 2.5;			// [0.4:0.2:50]

back_plate_height = 2.5;			// [0.4:0.2:50]

peg_length = 140;			// [10:180]

// distance as percentage of sign width
peg_distance = 0;                      // [10:100]
