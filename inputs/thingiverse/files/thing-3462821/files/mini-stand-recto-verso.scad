...
// First line of text (recto)
rectoString1 = "DO";

// Second line of text (recto)
rectoString2 = "NOT";

// Third line of text (recto)
rectoString3 = "TURN";

// Forth line of text (recto)
rectoString4 = "OFF";


// First line of text (verso)
versoString1 = "DO";

// Second line of text (verso)
versoString2 = "NOT";

// Third line of text (verso)
versoString3 = "TURN";

// Forth line of text (verso)
versoString4 = "ON";
	...
	linear_extrude(frameDepth) {
		...
		scale([textScale, textScale]) {
			translate([0, -textOffset]) {
				if (side == "recto") {
					text(rectoString1, font = font, halign = "center");
				} else {
					text(versoString1, font = font, halign = "center");
				}
			}
			translate([0, -textOffset - textLineHeight]) {
				if (side == "recto") {
					text(rectoString2, font = font, halign = "center");
				} else {
					text(versoString2, font = font, halign = "center");
				}
			}
			translate([0, -textOffset - textLineHeight*2]) {
				if (side == "recto") {
					text(rectoString3, font = font, halign = "center");
				} else {
					text(versoString3, font = font, halign = "center");
				}
			}
			translate([0, -textOffset - textLineHeight*3]) {
				if (side == "recto") {
					text(rectoString4, font = font, halign = "center");
				} else {
					text(versoString4, font = font, halign = "center");
				}
			}
		}
	}
