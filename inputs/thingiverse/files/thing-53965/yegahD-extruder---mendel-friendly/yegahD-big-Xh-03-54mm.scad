...
module rsqr(xa=4,ya=10,ha=20,ra=6.5){
translate([0,0,ha/2*-1])
hull(){
translate([-xa,ya,ha/2]) cylinder(r=ra,h=ha,center=true,$fn=26);
translate([-xa,-ya,ha/2]) cylinder(r=ra,h=ha,center=true,$fn=26);
translate([xa,0,ha/2]) cylinder(r=ra,h=ha,center=true,$fn=26);
//translate([xa,ya,ha/2]) cylinder(r=ra,h=ha,center=true,$fn=26);
}
}
...
translate([0,0,-.05+4]) difference(){ union(){
translate([0,0,-.025])
...
//#translate([0,0,2]) cylinder(r=ydia/(3.14/2)-17,h=totgt,center=true,$fn=26);

translate([0,0,4]) hull(){
rotate_extrude(convexity = 10, $fn = 66)
translate([ydia/(3.14/2)-17.5+.5, 0, 0])
circle(r = 5, $fn = 4);
}
...
hull(){
hull(){
rotate([0,0,-18]) translate([0,11.4,0.1+1]) cube(center=true,[(11.5/2+2.5)*1.2,1,1]);
rotate([0,0,-18]) translate([0,8+1,0.1+9]) cube(center=true,[(11.5/2+2.5)*0.8,1,1]);
//rotate([0,0,-18]) translate([0,8,0.1+9]) cube(center=true,[(11.5/2+2.5)*0.8,1,1]);
}
rotate([0,0,-18]) translate([0,0,0.1]) cylinder(r=11.5/2+6,r2=11.5/2+2.5,h=9.5,center=false,$fn=6);
}
}

rotate([0,0,-18]){ translate([0,0,6]) cylinder(r=nutrad/2,h=17,center=true,$fn=6);

for(j=[0:360/6:359]){
rotate([0,0,j]) translate([nutrad/2-.5,0,6]) cylinder(r=1.2/2,h=17,center=true,$fn=16);
}

translate([0,0,-3.5-.5]){
translate([0,6.4,9]) rotate([90,0,0]) rotate([0,0,30]) cylinder(r=6.2/2,h=3,center=true,$fn=6);
translate([0,9.6,9]) rotate([90,0,0]) cylinder(r=3.5/2,h=14,center=true,$fn=36);
}
}

intersection(){
translate([0,0,0]) cylinder(r=ydia/2-4-.4,h=27,center=true,$fn=66);
union(){
for(i=[120-1,240+1]){
rotate([0,0,i+60+12]){ 
translate([ydia/2.7,0,6]) rsqr(xa=2.8,ya=9,ha=20,ra=8);
}
}
rotate([0,0,0+60+12]) translate([ydia/2.7,0,6]) rsqr(xa=2.,ya=10,ha=20,ra=6.5);
}
}
