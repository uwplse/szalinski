...
//Choose the TShot
profile = "2020"; //[2020, 2040, 2060, 2080]

//Choose the Profile Core
profile_core = "M5"; //[M5, M6]
...
} else if(profile_core == "M6"){
    ProfileCore = 5.3;     // Profile core Ø (M6).
}

if(profile == "2020"){
    2020Profile(height_in_mm);
}else if(profile == "2040"){
    2040Profile(height_in_mm);
}
