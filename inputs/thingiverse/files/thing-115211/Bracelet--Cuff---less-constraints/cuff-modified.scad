...
Accent_Style = 1; // [0:Emboss Inscription,1:Engrave Inscription,2:Studs, 3:Holes, 4:Plain]
...
font_depth = 1; // [0.5,1,2,3,5,8,25:25 - Cutout]


//Would you like a bracket to attach a string or rope?
Attachment_Bracket = 1; //[0:None,1:One Side,2:Both Sides]
