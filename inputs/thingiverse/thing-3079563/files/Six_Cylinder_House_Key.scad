// Thingiverse File Name: Six_Cylinder_House_Key.scad
...
// Create a customized 6 cylinder (Kwikset) house key
...
first_cut = ( 0.097 * in2mm );
echo( "first_cut" , first_cut );

cylinder_spacing = [ first_cut , first_cut + cyl_spacing , first_cut + ( cyl_spacing * 2 ) , first_cut + ( cyl_spacing * 3 ) , first_cut + ( cyl_spacing * 4 ) , first_cut + ( cyl_spacing * 5 ) ];
...
// 6 'character' random number
random_key = str( floor( random_key_array[0] ) , floor( random_key_array[1] ) , floor( random_key_array[2] ) , floor( random_key_array[3] ) , floor( random_key_array[4] ) , floor( random_key_array[5] ) );
