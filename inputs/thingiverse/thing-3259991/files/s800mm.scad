...
module anti_leg(height) {
    ...
    translate([leg_length, 0, -height-4]) scale([1,1,2]) hex_nut (height, 3, 6, 0.1, 32, 0, "metric");
    translate([-leg_length, 0, -height-4]) scale([1,1,2]) hex_nut (height, 3, 6, 0.1, 32, 0, "metric");
}
...
difference() {
    union() {
        ...
        translate([0,0,-2.5]) cylinder(r=22, h=5);
        translate([0,10.5,-7.5]) cube([3,23,10], center=true);
        translate([0,0,-5]) cube([3,25,5], center=true);
        
        translate([-25,0,-10]) cylinder(r=2.5, h=10);
        translate([25,0,-10]) cylinder(r=2.5, h=10);
    ...
    translate([0, -18, -10]) cylinder(r=7,h=20);
