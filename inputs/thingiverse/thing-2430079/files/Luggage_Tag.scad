...
text_style=-80; // [-100:Through engraving (100 %),-80:Deep engraving (80 %),-50:Half way through engraving (50 %),-10:Shallow engraving (10 %),0: Hide text inside (takes 66 %),10:Little embossing (10 %),25:Heavy embossing (25 %) ] 
...
difference () {
	...
	union () {
		...
		cylinder (r=slitwidth/2,h=plate_thickness+0.1,$fn=50);
