...
test_file! {file_cnc_endmill,  222, "cads/pldi2020-eval/input/cnc_endmill_with_hull.csexp" }
test_file! {file_cnc_no_hull,  119, "cads/pldi2020-eval/input/cnc_endmill_nohull.csexp" }
